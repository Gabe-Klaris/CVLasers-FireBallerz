...
from shape_finders import find_triangles, find_squares, find_circles, find_octagons
...
if __name__ == '__main__':
    ...
    while True:
        ...
        centers = find_triangles(frame, (0, 0, 255), color_tolerance=10**10)
        display_frame = frame.copy()
        for center in centers:
            cv2.circle(display_frame, center, 5, (0, 255, 0), -1)
        cv2.imshow('Triangles', display_frame)
